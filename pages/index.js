...
import emoji from "/ahamed-wave.png";
import rlogo from "/react-logo.webp";
import rqlogo from "/react-query-logo.png";
import relogo from "/redux-logo.png";
import rrlogo from "/react-router-logo.png";

import awscertlogo from "/AWS-Certified_Cloud-Practitioner-logo.png";
import awslogo from "/aws-logo.png";
import bslogo from "/bootstrap-logo.jpeg";
import jslogo from "/JavaScript-logo.png";
import csslogo from "/css-logo.png";
import gitlogo from "/git-logo.png";
import githublogo from "/github-logo.png";
import htmllogo from "/html-logo.webp";
import tailwindlogo from "/tailwind-css-logo.png";
import sasslogo from "/sass-logo.png";
import jiralogo from "/jira-logo.png";
import nodelogo from "/node-logo.png";
import mongodblogo from "/mongodb-logo.png";
import scrumlogo from "/scrum-logo.png";
import expresslogo from "/expressjs-logo.png";
import firebaselogo from "/firebase-logo.png";
import vscodelogo from "/visual-studio-code-logo.webp";
import Image from "next/image";
import web1 from "/project-ss1.png";
import web2 from "/project-ss2.png";
import web3 from "/project-ss3.png";
...
export default function Home() {
  ...
  return (
    <div className={darkMode ? "dark" : ""} id="home">
      ...
      <header className="text-black top-0 z-10">
        <nav className="to-teal-500 pt-5 pb-2 px-5 md:px-10 flex flex-col md:flex-row justify-between dark:bg-gray-900 dark:text-white">
          <h1 className="font-burtons text-xl text-gray-800 hover:text-[#378CE7] dark:hover:text-[#41C9E2] dark:text-white transition-colors duration-300 mb-4 md:mb-0">
            <a href="#home">ahamed abdul khader</a>
          </h1>
          <ul className="flex items-center space-x-8">
            ...
            <li>
              <a
                className="bg-gradient-to-r from-[#41C9E2] to-[#378CE7] hover:from-[#162c44] hover:to-[#162c44] transition duration-300 text-white px-4 py-2 border-none rounded-md ml-0"
      ...
      <main className="bg-white px-4 md:px-8 lg:px-20 dark:bg-gray-900">
